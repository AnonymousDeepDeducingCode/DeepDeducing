...
for i in range(optimal_trials):
    ...
    for j in range(total_score_list.shape[0]):
        ...
        random_input_inner_for_player_A, random_input_inner_for_player_B = Machine.deduct_from(random_input_inner_for_player_A, random_input_inner_for_player_B)
...
axarr[0].plot(x, y, color = 'blue')
axarr[0].set_ylabel(r'$number \, of \, NEs \, found$', fontsize=8)
axarr[0].set_xlabel(r'$epochs$', fontsize=8)
axarr[0].set_title(r'$Deep \, Deducing \, Accuracy \, for \, 2x2 \, game \, table$', fontsize = 8)
...
for i in range(x.shape[0]):
    x[i] = initial_epochs + i * interval + interval
axarr[1].plot(x, y, color = 'blue')
axarr[1].set_ylabel(r'$number \, of \, NEs \, found$', fontsize=8)
axarr[1].set_xlabel(r'$epochs$', fontsize=8)
axarr[1].set_title(r'$Deep \, Deducing \, Accuracy \, for \, 4x4 \, game \, table$', fontsize = 8)
