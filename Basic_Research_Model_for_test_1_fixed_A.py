...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def train_for_random_input_inner_player_A(self,
        ...
        if self.randomness == "True":
            original = self.random_input_inner_for_player_A
            ...
            self.random_input_inner_for_player_A += (self.random_input_inner_for_player_A - original) * self.beta
        else:
            original                              = self.random_input_inner_for_player_A
    ...
    def deduct_from(self, random_input_inner_for_player_A, random_input_inner_for_player_B, desired_payoff_for_player_A, desired_payoff_for_player_B, axarr):
        ...
        for i in range(self.rounds):
            ...
            if i % 10 == 0:
                ...
                axarr.plot(np.round(self.processor(self.random_input_inner_for_player_B), 2)[0],np.round(self.processor(self.random_input_inner_for_player_A), 2)[0], 'b.')
