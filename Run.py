...
for form in range(number_of_trails):
    ...
    model   = "self.synapse_list_6x6_100x100x100_0.000001_400m_tilt_30_flexible_silent.npy"                                                          # <------------------------------------------------------
    tilt_1  = "self.tilt_1_list_6x6_100x100x100_0.000001_400m_tilt_30_flexible_silent.npy"                                                     # <------------------------------------------------------
