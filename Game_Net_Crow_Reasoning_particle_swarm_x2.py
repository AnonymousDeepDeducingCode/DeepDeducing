...
#=======================================================================================================================
    ...
    def train_for_inputs_leader_(self,selected_movements,
                       layer_0_values,
                       layer_1_values,
                       layer_2_values,
                       layer_3_values,
        ...
        self.leader_ += layer_0_delta_list[-self.present_trainee-1] * self.beta       #----------------------------------------------


    def train_for_inputs_particle_(self,selected_movements,
                       layer_0_values,
                       layer_1_values,
                       layer_2_values,
                       layer_3_values,
        ...
        self.particle_ += layer_0_delta_list[-self.present_trainee-1] * self.beta       #----------------------------------------------




    def train_for_inputs_particle_2_(self,selected_movements,
                       layer_0_values,
                       layer_1_values,
                       layer_2_values,
                       layer_3_values,
        ...
        self.particle_2_ += layer_0_delta_list[-self.present_trainee-1] * self.beta       #----------------------------------------------
    ...
    def train_for_inputs_particle_2_momentum(self,selected_movements,
                       layer_0_values,
                       layer_1_values,
                       layer_2_values,
                       layer_3_values,
        ...
        self.particle_2           += self.momentum_particle_2 * self.beta + layer_0_delta_list[-self.present_trainee-1] * self.beta + (self.best - self.particle_2) * self.beta      #----------------------------------------------
        self.momentum_particle_2   = self.momentum_particle_2 * self.beta + layer_0_delta_list[-self.present_trainee-1] * self.beta + (self.best - self.particle_2) * self.beta      #---------------------------------------------
    ...
    def deduct_from(self, initial_map, selected_movements, final_map):
        ...
        for i in range(self.rounds):
            ...
            for j in range(self.selected_movements_inner.shape[0]):
                ...
                self.particle_2  = (np.random.random(self.selected_movements_inner.shape[1]) - 0.5) * 0.5
                ...
                self.momentum_particle_2 = np.zeros(self.selected_movements_inner.shape[1])



                for j in range(100):

                    self.leader_     = self.leader
                    self.particle_   = self.particle
                    self.particle_2_ = self.particle_2


                    # MOVING FORWARD ------------------------------------------------------------------------

                    self.selected_movements_inner_leader = self.selected_movements_inner
                    self.selected_movements_inner_leader[self.present_trainee]     = self.leader_
                    self.selected_movements_inner_particle = self.selected_movements_inner
                    self.selected_movements_inner_particle[self.present_trainee]   = self.particle_
                    self.selected_movements_inner_particle_2 = self.selected_movements_inner
                    self.selected_movements_inner_particle_2[self.present_trainee] = self.particle_2_
                    ...
                    selected_movements_particle_2 = self.sigmoid(self.selected_movements_inner_particle_2)
                    ...
                    layer_0_values_particle_2, \
                    layer_1_values_particle_2, \
                    layer_2_values_particle_2, \
                    layer_3_values_particle_2 = self.generate_values_for_each_layer_RNN(initial_map, selected_movements_particle_2)

                    self.train_for_inputs_leader_(selected_movements_leader,
                                          layer_0_values_leader,
                                          layer_1_values_leader,
                                          layer_2_values_leader,
                                          layer_3_values_leader,
                                          final_map)
                    self.train_for_inputs_particle_(selected_movements_particle,
                                          layer_0_values_particle,
                                          layer_1_values_particle,
                                          layer_2_values_particle,
                                          layer_3_values_particle,
                                          final_map)
                    self.train_for_inputs_particle_2_(selected_movements_particle_2,
                                          layer_0_values_particle_2,
                                          layer_1_values_particle_2,
                                          layer_2_values_particle_2,
                                          layer_3_values_particle_2,
                                          final_map)
                    ...
                    candidate = np.argmin(np.array([np.sum((final_map - layer_3_values_leader) ** 2) ,                                      #
                                                    ...
                                                    np.sum((final_map - layer_3_values_particle_2) ** 2)
                                                    ]))
                    if candidate == 0:
                        self.best = self.leader_                                                                                                   #
                    if candidate == 1:
                        self.best = self.particle_                                                                                                #
                    if candidate == 2:
                        self.best = self.particle_2_                                                                                                #
                    ...
                    self.selected_movements_inner_particle_2[self.present_trainee] = self.particle_2
                    ...
                    self.train_for_inputs_particle_momentum(selected_movements_particle,
                                          ...
                                          layer_3_values_particle,
                                          final_map)
                    self.train_for_inputs_particle_2_momentum(selected_movements_particle_2,
                                                            layer_0_values_particle_2,
                                                            layer_1_values_particle_2,
                                                            layer_2_values_particle_2,
                                                            layer_3_values_particle_2,
                ...
                if candidate == 2:
                    self.selected_movements_inner[self.present_trainee] = self.particle_2                                                                                                #
