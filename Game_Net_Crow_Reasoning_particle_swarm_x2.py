...
#=======================================================================================================================
    ...
    def train_for_inputs_particle_2(self,selected_movements,
                       layer_0_values,
                       layer_1_values,
                       layer_2_values,
                       layer_3_values,
        ...
        self.particle_2 += layer_0_delta_list[-self.present_trainee-1] * self.beta       #----------------------------------------------
            ...
            for j in range(self.selected_movements_inner.shape[0]):
                ...
                for j in range(100):
                    ...
                    self.train_for_inputs_particle(selected_movements_particle,
                                          ...
                                          final_map)
                    self.train_for_inputs_particle_2(selected_movements_particle_2,
                                          layer_0_values_particle_2,
                                          layer_1_values_particle_2,
                                          layer_2_values_particle_2,
                    ...
                    self.particle_2 = saved_particle_2
